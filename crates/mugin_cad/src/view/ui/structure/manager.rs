...
use eframe::egui;
use mugin_widgets::window; // Use the new helper
...
pub fn render_structure_manager(ctx: &egui::Context, vm: &mut CadViewModel) {
    ...
    window::window(
        ...
        |ui| {
            ui.horizontal(|ui| {
                let _ = ui.selectable_label(true, "Materials");
                // Future: Column Types tab
                let _ = ui.selectable_label(false, "Column Types");
            });
            ui.separator();
